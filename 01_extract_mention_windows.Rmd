...
"Burnman", "burnman",
"Calypso",
"Citcom", "citcomcu", "citcomS", "citcoms",
"ConMan", "conman",
"Ellipsis3d", "ellipsis", "ellipsis3d",
"FLEXWIN",
" Gale ",    # avoid "Galerkin"
...
"SELEN", "selen ",
"SNAC",
"SPECFEM", "specfem2d", "specfem3d_globe", "specfem3d_cartesian",
"SW4", "sw4",
"Virtual California")
```
...
df1 <- mutate(df1, software_name = case_when(software_name== "axisem" ~ "AxiSEM",
                                             software_name == "burnman" ~ "Burnman",
                                             software_name %in% c("citcomcu", "citcomS", "citcoms") ~ "Citcom",
                                             software_name == "conman" ~ "ConMan",
                                             software_name %in% c("ellipsis", "ellipsis3d") ~ "Ellipsis3d",
                                             software_name == "mineos" ~ "Mineos",
                                             software_name == "pylith" ~ "PyLith",
                                             software_name == "seismic cpml" ~ "SEISMIC_CPML",
                                             software_name %in% c("specfem2d", "specfem3d_globe", "specfem3d_cartesian") ~ "SPECFEM",
...
ggsave(pylith, filename = "pylith.pdf", device = cairo_pdf, width = 11, height = 8)
```
